	...
	\begin{loesungssektion}{sec:aufg-kurve1}
		...
		\begin{komplexloesungen}{sec:aufg-kurve1}
			...
			\komplexloesung{}{
				...
				\item (Skizze)
				\item $f'(-1)=8$, $f'(1)=-4$, $f'(3)=8$; Schnittwinkel mit $x$-Achse: $\arctan(8)\approx83°$, $\arctan(4)\approx76°$
...
\begin{komplexaufgaben}{sec:kombinatorik}
	...
	\komplexaufgabe{Auf einem Rummelplatz wird ein Minilotto \glqq{}4 aus 16\grqq{} angeboten.
		Der Spieleinsatz beträgt pro Tipp $1\,€$.
		Die Auszahlungsquoten lauten $10\,€$ bei 3 Richtigen und $1000\,€$ bei 4 Richtigen.
