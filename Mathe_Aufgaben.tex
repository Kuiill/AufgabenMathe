...
\begin{document}
	...
	\begin{komplexloesungen}{sec:explogfktAblExWP}
	\komplexloesung{$A=\int_{-1}^{2} (e^{-0.5x})\,\mathrm{d}x-\int_{-1}^{0} -\sqrt{e}\cdot x\,\mathrm{d}x\approx1.74$}{}

	\komplexloesung{$f(x)=\frac{1}{2}x^2-2x+2.5$, $g(x)=2.5e^{\frac{1}{3}\ln 0.4\cdot x}$, $A=\int_{0}^{3} (g(x)-f(x))\,\mathrm{d}x\approx 1.91$}{}
